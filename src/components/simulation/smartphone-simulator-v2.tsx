  ...
  return (
    <div className="mx-auto max-w-[1000px] flex flex-col md:flex-row gap-6 items-start">
      ...
      <div className="flex-shrink-0 w-full md:w-[320px]">
        ...
        {/* Smartphone frame with side notches */}
        <div className="relative w-full md:w-[320px]">
          {/* Main device frame with thicker border */}
          <div className="border-[12px] border-black rounded-[2.5rem] overflow-hidden shadow-xl bg-white relative">
            {/* Left side buttons */}
            <div className="absolute -left-[14px] top-[100px] h-[30px] w-[3px] bg-gray-800 rounded-l-sm"></div>
            <div className="absolute -left-[14px] top-[140px] h-[60px] w-[3px] bg-gray-800 rounded-l-sm"></div>
            
            {/* Right side button */}
            <div className="absolute -right-[14px] top-[120px] h-[40px] w-[3px] bg-gray-800 rounded-r-sm"></div>
            
            {/* Top notch */}
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[130px] h-[28px] bg-black rounded-b-[14px] z-10"></div>
            
            {/* Phone status bar (update padding-top to accommodate notch) */}
            <div className="bg-black text-white px-4 pt-7 pb-2 flex justify-between items-center">
              <div className="absolute top-[14px] left-1/2 transform -translate-x-1/2 flex items-center justify-center gap-2 w-[100px]">
                <div className="w-[8px] h-[8px] rounded-full bg-gray-700"></div>
                <div className="w-[40px] h-[4px] rounded-full bg-gray-700"></div>
                <div className="w-[8px] h-[8px] rounded-full bg-gray-700"></div>
              </div>
              <div>{currentTime}</div>
              <div className="flex items-center gap-1">
                <div className="flex space-x-1 items-center">
                  <div className="h-[10px] w-[3px] bg-white rounded-sm"></div>
                  <div className="h-[7px] w-[3px] bg-white rounded-sm"></div>
                  <div className="h-[5px] w-[3px] bg-white rounded-sm"></div>
                  <div className="h-[3px] w-[3px] bg-white rounded-sm"></div>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M17.778 8.222c-4.296-4.296-11.26-4.296-15.556 0A1 1 0 01.808 6.808c5.076-5.077 13.308-5.077 18.384 0a1 1 0 01-1.414 1.414zM14.95 11.05a7 7 0 00-9.9 0 1 1 0 01-1.414-1.414 9 9 0 0112.728 0a1 1 0 01-1.414 1.414zM12.12 13.88a3 3 0 00-4.242 0 1 1 0 01-1.415-1.415 5 5 0 017.072 0 1 1 0 01-1.415 1.415zM9 16a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
                </svg>
                <div className="ml-1 font-medium">100%</div>
              </div>
            </div>
            ...
            {/* Messages container */}
            <div className="bg-[#f7f7f7] p-4 h-[350px] overflow-y-auto">
              {/* Messages */}
